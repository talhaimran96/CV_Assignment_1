# This part is the implementation of classification of the flower dataset using SVM and different number of clusters
...
save_classification_report(report=report, path="../results/Flowers_SVM", k=k)

examples_predictions = svm_classifier.predict(x_)
